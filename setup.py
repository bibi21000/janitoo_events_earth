...
setup(
    name = 'janitoo_events_earth',
    description = "Earth (dawn, dusk, fullmoon, ... based events components",
    long_description = "Earth (dawn, dusk, fullmoon, ... based events components",
    ...
    entry_points = {
        "janitoo.components": [
            "events.dawndusk = janitoo_events_earth.component:make_dawndusk",
        ],
        "events.extensions": [
            "earth = janitoo_events_earth.bus:extend",
        ],
    },
    dependency_links = [
